 ...
 */
export declare function scalePoint(
    point: number,
    scale: number,
    originPoint: number
): number
 ...
 */
export declare function applyPointDelta(
    point: number,
    translate: number,
    scale: number,
    originPoint: number,
 ...
 */
export declare function applyAxisDelta(
    axis: Axis,
 ...
 * and applyAxisDelta
 */
export declare function applyAxisTransforms(
    final: Axis,
    axis: Axis,
 ...
 */
export declare function applyBoxTransforms(
    finalBox: AxisBox2D,
    box: AxisBox2D,
    transforms: ResolvedValues
): void
 ...
 */
export declare function removePointDelta(
    point: number,
    translate: number,
    scale: number,
    originPoint: number,
 ...
 */
export declare function removeAxisDelta(
    axis: Axis,
    translate?: number,
    scale?: number,
    origin?: number,
 ...
 */
export declare function removeAxisTransforms(
    axis: Axis,
    transforms: ResolvedValues,
    [key, scaleKey, originKey]: string[]
): void
 ...
 * and acts as a bridge between motion values and removeAxisDelta
 */
export declare function removeBoxTransforms(
    box: AxisBox2D,
    transforms: ResolvedValues
): void
/**
 ...
 */
export declare function applyTreeDeltas(
    box: AxisBox2D,
    treeScale: Point2D,
