 ...
 */
export declare function buildTransform(
 ...
 * undefined origins.
 */
export declare function buildTransformOrigin({
    originX,
    originY,
    originZ,
 ...
 */
export declare function buildLayoutProjectionTransform(
    { x, y }: BoxDelta,
    treeScale: Point2D,
 ...
 */
export declare function buildLayoutProjectionTransformOrigin({
    x,
    y,
}: BoxDelta): string
