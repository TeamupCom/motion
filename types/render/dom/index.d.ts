...
declare type CustomMotionComponent = {
    custom: <Props>(Component: string | React.ComponentType<Props>) => CustomDomComponent<Props>;
};
 ...
 * @public
 */
declare function origCreateMotionProxy(defaultFeatures: MotionFeature[]): Motion;
export declare const createMotionProxy: typeof origCreateMotionProxy;
/**
