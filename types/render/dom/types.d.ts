 ...
 */
declare type UnwrapFactoryAttributes<F> = F extends DetailedHTMLFactory<
    infer P,
    any
>
    ? P
    : never
declare type UnwrapFactoryElement<F> = F extends DetailedHTMLFactory<
    any,
    infer P
>
    ? P
    : never
declare type UnwrapSVGFactoryElement<F> = F extends React.SVGProps<infer P>
    ? P
    : never
 ...
 * @public
 */
export declare type HTMLMotionProps<
