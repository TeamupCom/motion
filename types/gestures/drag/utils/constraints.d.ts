 ...
 */
export declare function applyConstraints(
    point: number,
 ...
 */
export declare function calcConstrainedMinPoint(
    point: number,
    length: number,
    progress: number,
 ...
 */
export declare function calcRelativeAxisConstraints(
    axis: Axis,
    min?: number,
    max?: number
): Partial<Axis>
 ...
 */
export declare function calcRelativeConstraints(
    layoutBox: AxisBox2D,
 ...
 */
export declare function calcViewportAxisConstraints(
    layoutAxis: Axis,
 ...
 */
export declare function calcViewportConstraints(
    layoutBox: AxisBox2D,
 ...
 */
export declare function calcProgressWithinConstraints(
    layoutBox: AxisBox2D,
    constraintsBox: AxisBox2D
): Point2D
/**
 ...
 */
export declare function calcPositionFromProgress(
    axis: Axis,
    constraints: Axis,
    progress: number
): Axis
 ...
 */
export declare function rebaseAxisConstraints(
    layout: Axis,
    constraints: Partial<Axis>
): Partial<Axis>
